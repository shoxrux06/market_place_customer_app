...
VideoListResponseTest videoListResponseTestFromJson(String str) => VideoListResponseTest.fromJson(json.decode(str));
String videoListResponseTestToJson(VideoListResponseTest data) => json.encode(data.toJson());
class VideoListResponseTest {
  ...
  VideoListResponseTest.fromJson(dynamic json) {
    _id = json['id'];
    _width = json['width'];
    _height = json['height'];
    _url = json['url'];
...
VideoListResponseTest copyWith({  num? id,
  num? width,
  num? height,
  String? url,
  String? image,
  ...
  List<VideoFiles>? videoFiles,
  List<VideoPictures>? videoPictures,
}) => VideoListResponseTest(  id: id ?? _id,
  width: width ?? _width,
...
VideoPictures videoPicturesFromJson(String str) => VideoPictures.fromJson(json.decode(str));
String videoPicturesToJson(VideoPictures data) => json.encode(data.toJson());
class VideoPictures {
  VideoPictures({
      num? id, 
      String? picture, 
...
VideoFiles videoFilesFromJson(String str) => VideoFiles.fromJson(json.decode(str));
String videoFilesToJson(VideoFiles data) => json.encode(data.toJson());
class VideoFiles {
  VideoFiles({
      num? id, 
      String? quality, 
