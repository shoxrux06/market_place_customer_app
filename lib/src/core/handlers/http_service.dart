...
import 'package:g_customer/src/core/handlers/token_interceptor2.dart';
...
class HttpService {
  ...
  Dio clientDel({bool requireAuth = false}) => Dio(
    BaseOptions(
      baseUrl: AppConstants.baseUrl,
      connectTimeout: 60 * 1000,
      receiveTimeout: 60 * 1000,
    ...
    ..interceptors.add(TokenInterceptor2(requireAuth: requireAuth))
    ..interceptors.add(LogInterceptor());
