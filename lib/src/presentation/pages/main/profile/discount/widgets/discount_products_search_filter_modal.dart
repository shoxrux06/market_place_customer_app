...
class DiscountProductsSearchFilterModal extends ConsumerWidget {
  const DiscountProductsSearchFilterModal({Key? key}) : super(key: key);
                              ...
                              : ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    return BrandFilterItem(
                                      isSelected: state.selectedSearchBrandId ==
                                          brand.id,
                                      brand: brand,
