...
part of 'profitable_products_state.dart';
...
/// @nodoc
mixin _$ProfitableProductsState {
  ...
  @JsonKey(ignore: true)
  $ProfitableProductsStateCopyWith<ProfitableProductsState> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ProfitableProductsStateCopyWith<$Res> {
  factory $ProfitableProductsStateCopyWith(ProfitableProductsState value,
          $Res Function(ProfitableProductsState) then) =
      _$ProfitableProductsStateCopyWithImpl<$Res>;
  $Res call(
      {bool isLoading,
      bool isSearching,
...
/// @nodoc
class _$ProfitableProductsStateCopyWithImpl<$Res>
    implements $ProfitableProductsStateCopyWith<$Res> {
  _$ProfitableProductsStateCopyWithImpl(this._value, this._then);

  final ProfitableProductsState _value;
  // ignore: unused_field
  final $Res Function(ProfitableProductsState) _then;
...
/// @nodoc
abstract class _$$_ProfitableProductsStateCopyWith<$Res>
    implements $ProfitableProductsStateCopyWith<$Res> {
  factory _$$_ProfitableProductsStateCopyWith(_$_ProfitableProductsState value,
          $Res Function(_$_ProfitableProductsState) then) =
      __$$_ProfitableProductsStateCopyWithImpl<$Res>;
  @override
  $Res call(
      {bool isLoading,
      bool isSearching,
...
/// @nodoc
class __$$_ProfitableProductsStateCopyWithImpl<$Res>
    extends _$ProfitableProductsStateCopyWithImpl<$Res>
    implements _$$_ProfitableProductsStateCopyWith<$Res> {
  __$$_ProfitableProductsStateCopyWithImpl(_$_ProfitableProductsState _value,
      $Res Function(_$_ProfitableProductsState) _then)
      : super(_value, (v) => _then(v as _$_ProfitableProductsState));

  @override
  _$_ProfitableProductsState get _value =>
      super._value as _$_ProfitableProductsState;
  ...
  $Res call({
    ...
    return _then(_$_ProfitableProductsState(
      isLoading: isLoading == freezed
          ? _value.isLoading
          : isLoading // ignore: cast_nullable_to_non_nullable
              as bool,
...
class _$_ProfitableProductsState extends _ProfitableProductsState {
  const _$_ProfitableProductsState(
  ...
  @override
  String toString() {
    return 'ProfitableProductsState(isLoading: $isLoading, isSearching: $isSearching, isSearchLoading: $isSearchLoading, isMoreLoading: $isMoreLoading, isCategoriesLoading: $isCategoriesLoading, isBrandsLoading: $isBrandsLoading, products: $products, searchedProducts: $searchedProducts, categories: $categories, brands: $brands, selectedCategoryId: $selectedCategoryId, selectedBrandId: $selectedBrandId, selectedSearchCategoryId: $selectedSearchCategoryId, selectedSearchBrandId: $selectedSearchBrandId, query: $query, listAlignment: $listAlignment)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_ProfitableProductsState &&
  ...
  @JsonKey(ignore: true)
  @override
  _$$_ProfitableProductsStateCopyWith<_$_ProfitableProductsState>
      get copyWith =>
          __$$_ProfitableProductsStateCopyWithImpl<_$_ProfitableProductsState>(
              this, _$identity);
}

abstract class _ProfitableProductsState extends ProfitableProductsState {
  const factory _ProfitableProductsState(
      {final bool isLoading,
      final bool isSearching,
      final bool isSearchLoading,
      final bool isMoreLoading,
      ...
      final int selectedSearchBrandId,
      final String query,
      final ListAlignment listAlignment}) = _$_ProfitableProductsState;
  const _ProfitableProductsState._() : super._();
