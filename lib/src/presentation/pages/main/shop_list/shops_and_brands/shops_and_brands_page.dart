...
import '../often_buy/widgets/often_buy_products_filter_modal.dart';
import '../often_buy/widgets/often_buy_products_search_filter_modal.dart';


class ShopsAndBrandsPage extends ConsumerStatefulWidget {
  const ShopsAndBrandsPage({Key? key, required this.shopName}) : super(key: key);

  final String shopName;
  @override
  ConsumerState<ShopsAndBrandsPage> createState() =>
      _OftenBuyProductsPageState();
}

class _OftenBuyProductsPageState extends ConsumerState<ShopsAndBrandsPage> {
  @override
  void initState() {
    super.initState();
    Future.delayed(
