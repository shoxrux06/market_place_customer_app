...
part of 'banner_details_state.dart';
...
mixin _$BannerDetailsState {
  ...
  @JsonKey(ignore: true)
  $BannerDetailsStateCopyWith<BannerDetailsState> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $BannerDetailsStateCopyWith<$Res> {
  factory $BannerDetailsStateCopyWith(
          BannerDetailsState value, $Res Function(BannerDetailsState) then) =
      _$BannerDetailsStateCopyWithImpl<$Res>;
  $Res call(
      {bool isLoading,
      bool isSearching,
...
/// @nodoc
class _$BannerDetailsStateCopyWithImpl<$Res>
    implements $BannerDetailsStateCopyWith<$Res> {
  _$BannerDetailsStateCopyWithImpl(this._value, this._then);

  final BannerDetailsState _value;
  // ignore: unused_field
  final $Res Function(BannerDetailsState) _then;
...
/// @nodoc
abstract class _$$_BannerDetailsStateCopyWith<$Res>
    implements $BannerDetailsStateCopyWith<$Res> {
  factory _$$_BannerDetailsStateCopyWith(_$_BannerDetailsState value,
          $Res Function(_$_BannerDetailsState) then) =
      __$$_BannerDetailsStateCopyWithImpl<$Res>;
  @override
  $Res call(
      {bool isLoading,
      bool isSearching,
...
/// @nodoc
class __$$_BannerDetailsStateCopyWithImpl<$Res>
    extends _$BannerDetailsStateCopyWithImpl<$Res>
    implements _$$_BannerDetailsStateCopyWith<$Res> {
  __$$_BannerDetailsStateCopyWithImpl(
      _$_BannerDetailsState _value, $Res Function(_$_BannerDetailsState) _then)
      : super(_value, (v) => _then(v as _$_BannerDetailsState));

  @override
  _$_BannerDetailsState get _value => super._value as _$_BannerDetailsState;
  ...
  $Res call({
    ...
    return _then(_$_BannerDetailsState(
      isLoading: isLoading == freezed
          ? _value.isLoading
          : isLoading // ignore: cast_nullable_to_non_nullable
              as bool,
...
class _$_BannerDetailsState extends _BannerDetailsState {
  const _$_BannerDetailsState(
  ...
  @override
  String toString() {
    return 'BannerDetailsState(isLoading: $isLoading, isSearching: $isSearching, isSearchLoading: $isSearchLoading, isCategoriesLoading: $isCategoriesLoading, isBrandsLoading: $isBrandsLoading, products: $products, filteredProducts: $filteredProducts, searchedProducts: $searchedProducts, categories: $categories, brands: $brands, productsCount: $productsCount, selectedCategoryId: $selectedCategoryId, selectedBrandId: $selectedBrandId, selectedSearchCategoryId: $selectedSearchCategoryId, selectedSearchBrandId: $selectedSearchBrandId, query: $query, listAlignment: $listAlignment)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_BannerDetailsState &&
  ...
  @JsonKey(ignore: true)
  @override
  _$$_BannerDetailsStateCopyWith<_$_BannerDetailsState> get copyWith =>
      __$$_BannerDetailsStateCopyWithImpl<_$_BannerDetailsState>(
          this, _$identity);
}

abstract class _BannerDetailsState extends BannerDetailsState {
  const factory _BannerDetailsState(
      {final bool isLoading,
      final bool isSearching,
      final bool isSearchLoading,
      final bool isCategoriesLoading,
      ...
      final int selectedSearchBrandId,
      final String query,
      final ListAlignment listAlignment}) = _$_BannerDetailsState;
  const _BannerDetailsState._() : super._();
