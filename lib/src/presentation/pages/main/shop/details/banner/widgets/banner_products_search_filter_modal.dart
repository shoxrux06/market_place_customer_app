...
class BannerProductsSearchFilterModal extends ConsumerWidget {
  const BannerProductsSearchFilterModal({Key? key}) : super(key: key);
                        ...
                        state.isCategoriesLoading
                          ...
                          children: state.categories
                              ...
                              state.selectedSearchCategoryId ==
                                  category.id,
                              onTap: () =>
                                  notifier.setSelectedSearchCategoryId(
                                    category.id,
                                  ),
                            ),
                          )
                        ...
                        state.isBrandsLoading
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return BrandFilterItem(
                              ...
                              onTap: () =>
                                  notifier.setSelectedSearchBrandId(brand.id),
                            );
                          },
                        ),
                      ],
