...
class MostSoldProductsNotifier extends StateNotifier<MostSoldProductsState> {
  final BrandsRepository _brandsRepository;
  final ProductsRepository _productsRepository;
  final CategoriesRepository _categoriesRepository;
  Timer? _timer;

  MostSoldProductsNotifier(
    this._brandsRepository,
    this._productsRepository,
    this._categoriesRepository,
  ) : super(const MostSoldProductsState());
    ...
    if (connected) {
      ...
      response.when(
        ...
        failure: (failure) {
          ...
          debugPrint('==> get most sold products failure: $failure');
        },
      );
    } else {
      if (mounted) {
