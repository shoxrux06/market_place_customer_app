...
class CategoryProductsFilterModal extends ConsumerWidget {
  final int? categoryId;

  const CategoryProductsFilterModal({Key? key, this.categoryId})
      : super(key: key);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              AccentLoginButton(
                onPressed: () {
                  notifier.filterProducts(context, categoryId);
                  context.popRoute();
                },
