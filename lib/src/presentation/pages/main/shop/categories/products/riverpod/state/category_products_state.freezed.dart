...
class __$$_CategoryProductsStateCopyWithImpl<$Res>
  ...
  __$$_CategoryProductsStateCopyWithImpl(_$_CategoryProductsState _value,
      ...
      : super(_value, (v) => _then(v as _$_CategoryProductsState));

  @override
  _$_CategoryProductsState get _value =>
      super._value as _$_CategoryProductsState;
...
class _$_CategoryProductsState extends _CategoryProductsState {
  ...
  @override
  String toString() {
    return 'CategoryProductsState(isLoading: $isLoading, isSearching: $isSearching, isSearchLoading: $isSearchLoading, isMoreLoading: $isMoreLoading, isBrandsLoading: $isBrandsLoading, products: $products, searchedProducts: $searchedProducts, brands: $brands, productsCount: $productsCount, selectedBrandId: $selectedBrandId, selectedSearchBrandId: $selectedSearchBrandId, query: $query, listAlignment: $listAlignment)';
  }
...
abstract class _CategoryProductsState extends CategoryProductsState {
  const factory _CategoryProductsState(
      ...
      final int selectedSearchBrandId,
      final String query,
      final ListAlignment listAlignment}) = _$_CategoryProductsState;
