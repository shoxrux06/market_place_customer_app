...
class _$_RegisterState extends _RegisterState {
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.isEmailInvalid, isEmailInvalid) &&
            const DeepCollectionEquality()
                .equals(other.isPasswordInvalid, isPasswordInvalid) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(isEmailInvalid),
...
abstract class _RegisterState extends RegisterState {
  const factory _RegisterState(
      ...
      final String lastName,
      final String password,
      final String confirmPassword}) = _$_RegisterState;
